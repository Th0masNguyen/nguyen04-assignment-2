...
function runKMeans(dataset, centroids, clusters){
    ...
    while (!converged) {
        const { centroids:newCentroids, clusters:newClusters } = KMeansStep(dataset, currentCentroids, currentClusters);
...
export {randomData, initializeCentroids, assignClusters, runKMeans, KMeansStep};